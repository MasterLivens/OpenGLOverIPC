...
CxDemoGL::CxDemoGL( const QColor &background, const char *ipc_url):CxOpenGLIPC(ipc_url),
      m_showBubbles(true),
      m_qtLogo(true),
      m_frames(0),
      m_program1(0),
...
CxDemoGL::~CxDemoGL()
{
    ...
    this->_context.makeCurrent(&window);
    delete m_texture;
    delete m_program1;
    delete m_program2;
    delete m_vshader1;
    ...
    m_vbo1.destroy();
    m_vbo2.destroy();
    this->_context.doneCurrent();
}

void CxDemoGL::setScaling(int scale)
{
    if (scale > 30)
...
void CxDemoGL::setLogo()
{
    m_qtLogo = true;
}

void CxDemoGL::setTexture()
{
    m_qtLogo = false;
}

void CxDemoGL::setShowBubbles(bool bubbles)
{
    m_showBubbles = bubbles;
}

void CxDemoGL::paintQtLogo()
{
...
void CxDemoGL::paintTexturedCube()
{
    m_texture->bind();
...
void CxDemoGL::createBubbles(int number)
{
...
void CxDemoGL::quad(qreal x1, qreal y1, qreal x2, qreal y2, qreal x3, qreal y3, qreal x4, qreal y4)
{
...
void CxDemoGL::extrude(qreal x1, qreal y1, qreal x2, qreal y2)
{
    m_vertices << QVector3D(x1, y1, +0.05f);
    m_vertices << QVector3D(x2, y2, +0.05f);
    m_vertices << QVector3D(x1, y1, -0.05f);
...
#if 0
void CxDemoGL::setTransparent(bool transparent)
{
...
#endif
void CxDemoGL::resizeGL(int, int)
{
}
